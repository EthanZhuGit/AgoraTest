...
import io.agora.rtc.mediaio.app.monitor.CameraWrapper;
import io.agora.rtc.mediaio.app.utils.Logger1;
import io.agora.rtc.mediaio.app.utils.Utils;
...
public class RecordActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        compat = (SwitchCompat) findViewById(R.id.switch_compat);
...
//                startActivity(new Intent(RecordActivity.this, CreateNumberAct.class));
                return true;
            }
        });
        return true;
